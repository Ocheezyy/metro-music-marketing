                        ...
                        <Card className="bg-gray-800 bg-opacity-50 backdrop-blur-lg border-gray-700 text-gray-100">
                            ...
                            <CardContent>
                                <p className="text-sm text-gray-300">
                                    Founded in 2020, MusicBoost was born from a passion for music and a desire to help independent artists thrive in the digital age. Our team of industry veterans and tech innovators came together with a shared vision: to democratize music promotion and level the playing field for talented artists everywhere.
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="bg-gray-800 bg-opacity-50 backdrop-blur-lg border-gray-700 text-gray-100">
                            ...
                            <CardContent>
                                <p className="text-sm text-gray-300">
                                    At MusicBoost, our mission is to empower artists with the tools, strategies, and support they need to build sustainable careers in music. We believe that great talent deserves to be heard, and we&#39;re committed to helping artists connect with their audience and achieve their goals.
                                </p>
                            </CardContent>
                        </Card>
                        <Card className="bg-gray-800 bg-opacity-50 backdrop-blur-lg border-gray-700 text-gray-100">
                            ...
                            <CardContent>
                                <p className="text-sm text-gray-300">
                                    We combine industry expertise with cutting-edge technology to deliver results-driven promotion strategies. Our approach is always artist-centric, tailoring our services to each client&#39;s unique sound, style, and career goals. We stay ahead of industry trends to ensure our clients are always one step ahead.
                                </p>
                            </CardContent>
                        </Card>
                    </div>
                ...
                <div className="container px-4 md:px-6">
                    <div className="flex flex-col items-center space-y-4 text-center">
                        ...
                        <p className="mx-auto max-w-[600px] text-gray-300 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                            Let&#39;s create a tailored strategy to amplify your sound and grow your fanbase.
                        </p>

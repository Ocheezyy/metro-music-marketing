...
export default function SocialMediaManagement() {
    ...
    return (
        <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-hidden bg-gray-900 text-gray-100">
            <DialogHeader>
                <DialogTitle className="text-2xl font-bold text-gray-100">Social Media Management for Musicians</DialogTitle>
                ...
                <div className="space-y-6 max-w-3xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-gray-700 p-4 rounded-lg">
                            ...
                            <p className="text-gray-300">We&#39;ll create a monthly schedule filled with eye-catching posts, videos, reels, and stories that reflect your style and voice.</p>
                        </div>
                        ...
                        <div className="bg-gray-700 p-4 rounded-lg">
                            ...
                            <p className="text-gray-300">Never miss an opportunity to connect with your fans. We handle likes, comments, and DMs to keep your community thriving.</p>
                        </div>
                        ...
                        <div className="bg-gray-700 p-4 rounded-lg">
                            ...
                            <p className="text-gray-300">With advanced analytics, we monitor your progress and refine strategies to help you gain followers, boost engagement, and grow your fanbase.</p>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 bg-blue-900 p-6 rounded-lg">
                        ...
                        <p className="text-lg text-gray-300">
                            A well-managed social media presence can turn casual listeners into loyal superfans, helping you expand your reach and monetize your music.
                        </p>
                    </div>

                    <div className="mt-8">
                        <h3 className="text-2xl font-semibold mb-4 text-gray-100">Ready to Amplify Your Social Media Presence?</h3>
                        <p className="text-lg mb-4 text-gray-300">
                            Let&#39;s create a tailored social media strategy to boost your online presence and connect with your fans. Our team of experts is ready to help you take your music career to the next level.
                        </p>
                    ...
                    <div className="mt-8 text-sm text-gray-400">
                        ...
                        <p>social media management for musicians, Instagram for artists, grow music followers, TikTok music promotion, social media growth for artists</p>
                    </div>
                </div>
            </ScrollArea>
        </DialogContent>

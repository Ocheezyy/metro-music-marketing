...
export default function MusicPromotion() {
    ...
    return (
        ...
        <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-gray-100">Music Promotion Services</DialogTitle>
            <DialogDescription className="text-gray-400">
                Discover how we can help get your tracks in front of the right audience
            </DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-6 max-w-3xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-gray-700 p-4 rounded-lg">
                        ...
                        <p className="text-gray-300">We pitch your tracks to top Spotify, Apple Music, and YouTube playlists, giving your songs the visibility they deserve.</p>
                    </div>
                    ...
                    <div className="bg-gray-700 p-4 rounded-lg">
                        ...
                        <p className="text-gray-300">Using platforms like Facebook, Instagram, and YouTube, we run ads that target fans based on their music preferences, ensuring your sound reaches listeners who love your genre.</p>
                    </div>
                    ...
                    <div className="bg-gray-700 p-4 rounded-lg">
                        ...
                        <p className="text-gray-300">Collaborating with music influencers and bloggers, we create buzz around your releases, helping you tap into new audiences.</p>
                    </div>
                ...
                <div className="mt-8">
                    <h3 className="text-2xl font-semibold mb-4 text-gray-100">Ready to Amplify Your Music?</h3>
                    <p className="text-lg mb-4 text-gray-300">
                        Let&#39;s create a tailored strategy to boost your music and build your fanbase. Our team of experts is ready to help you take your music career to the next level.
                    </p>
                ...
                <div className="mt-8 text-sm text-gray-400">
                    ...
                    <p>music promotion services, Spotify playlist pitching, promote music online, best ways to market music, indie artist promotion</p>
                </div>
            </div>
        </ScrollArea>
        </DialogContent>

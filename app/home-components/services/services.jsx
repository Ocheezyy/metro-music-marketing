...
import {Globe, Heart, Instagram, Music, Paintbrush, Users, ArrowRight} from "lucide-react";
import {Card, CardContent, CardHeader, CardTitle} from "@/components/ui/card";
import {Dialog, DialogTrigger} from "@/components/ui/dialog"
import MusicPromotion from "@/app/home-components/services/dialogs/music-promotion";
import SocialMediaManagement from "@/app/home-components/services/dialogs/social-media-management";
import BrandDevelopment from "@/app/home-components/services/dialogs/brand-development";
import WebsiteEPK from "@/app/home-components/services/dialogs/website-epk";
import FanEngagement from "@/app/home-components/services/dialogs/fan-engagement";
import AdditionalServices from "@/app/home-components/services/dialogs/additional-services";
...
const Service = ({ service, idx }) => {
    ...
    return (
        ...
        <DialogTrigger asChild>
            <Card key={idx} className="bg-gray-800 bg-opacity-50 backdrop-blur-lg border-gray-700 text-gray-100 shadow-lg shadow-blue-500/20 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/30 hover:-translate-y-1 cursor-pointer group">
                <CardHeader>
...
const Services = () => {
    return (
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
            {services.map((service, idx) => <Service key={`service-${idx}`} service={service} idx={idx} />)}
        </div>
    )
}
